...
namespace Renter.Api.Controllers.UserIdentity
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        [HttpPost("signup")]
        public async Task<IActionResult> SignUp(RegisterModel userRegisterResource)
        {
            var user = _mapper.Map<RegisterModel, User>(userRegisterResource);

            var userCreateResult = await _userManager.CreateAsync(user, userRegisterResource.Password);
